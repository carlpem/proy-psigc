...
def vista_gestion(request):
    return render(request, "psigcges/gestion.html")
#
# SECCIÓN DE NOTICIAS
#
def vista_noticiabd(request):
    noticiasbd = Noticia.objects.all()
    return render(request, "psigcges/bdnoticias.html", {"noticiasdata":noticiasbd})
...
def vista_adinoticia(request):
    ...
    return render(request, "psigcges/edinoticia.html", {'edinotiform':adinotiform})
...
def vista_edinoticia(request, id_noti):  
    ...
    return render(request, "psigcges/edinoticia.html", {'edinotiform':edinotiform, 'idpost':id_noti})
...
def vista_eventobd(request):
    ...
    return render(request, "psigcges/bdeventos.html", {"eventosdata":eventosbd})
    ...
    if request.method =='POST':
        ...
        if adieventoform.is_valid():
            try:
                ...
                messages.add_message(request=request, level=messages.ERROR, message="Error al intentar crear información. Verifique los datos.")    
    return render(request, "psigcges/edievento.html", {"edieventoform":adieventoform})
    ...
    if request.method=='POST':
        ...
        if edieventoform.is_valid():
            try:
                ...
                messages.add_message(request=request, level=messages.ERROR, message="Error al actualizar la información. Verifique los datos.")
    return render(request, "psigcges/edievento.html", {"edieventoform":edieventoform})
...
def vista_documentobd(request):
    ...
    return render(request, "psigcges/bdocumentos.html", {"documentsdata":documentosbd})
...
def vista_adidocumento(request):
    ...
    return render(request, "psigcges/edidocumento.html", {'edidocform':adidocform})
    ...
    if request.method=='POST':
        ...
        if edidocform.is_valid():
            try:
                ...
                messages.add_message(request=request, level=messages.ERROR, message="Error al actualizar la información. Verifique los datos.")
    return render(request, "psigcges/edidocumento.html", {'edidocform':edidocform})
...
def vista_forobd(request):
    ...
    return render(request, "psigcges/bdforos.html", {'forosdata':foros})
...
def vista_adiforo(request):
    ...
    return render(request, "psigcges/ediforo.html",  {'ediforoform':adiforoform})
    ...
    if request.method=='POST':
        ...
        if ediforoform.is_valid():
            try:
                ...
                messages.add_message(request=request, level=messages.ERROR, message="Error al actualizar la información. Verifique los datos.")
    return render(request, "psigcges/ediforo.html", {'ediforoform':ediforoform})
...
def vista_edicoment(request, id_coment):
    ...
    return render(request, "psigcges/ediforo.html")
...
def vista_areaconocbd(request):
    ...
    return render(request, "psigcges/bdareaconoc.html", {'areasdata':areaconoc})
...
def vista_adiareaconoc(request):
    ...
    return render(request, "psigcges/ediareaconoc.html", {'areaform':adareaform})
...
def vista_ediareaconoc(request, id_areacon):  
    ...
    return render(request, "psigcges/ediareaconoc.html", {'areaform':updareaform})
